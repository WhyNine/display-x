# display-x
Display photo slideshow or play music from internet radio or Jellyfin server. This code is running on a Raspberry Pi 4 running Wayland with the official 7" 720x1280 touch display in portrait mode.
